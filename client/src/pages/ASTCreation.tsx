  ...
  return (
    <div className="flex items-center justify-center p-6 overflow-auto">
      <div className="bg-white p-8 rounded-lg shadow-md w-full">
        <h1 className="text-3xl font-semibold text-green-700">Create AST with Rule String</h1>
        <div className="mt-5">
          <label className="block text-green-600 font-bold mb-2" htmlFor="name">
            Enter Name
          </label>
          <input
            type="text"
        ...
        <div className="mt-5">
          <label className="block text-green-600 font-bold mb-2" htmlFor="rule">
            Enter Rule String
          </label>
          <textarea
            id="rule"
        ...
        <button
          ...
          className="bg-green-500 text-white py-2 px-4 rounded-md hover:bg-green-600 mt-4 right-0"
        >
          Submit
        </button>
        <div className="mt-6">
